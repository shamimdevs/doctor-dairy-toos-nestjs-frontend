...
const AllProductCategory: React.FC = () => {
    ...
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-6 border-b border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <Link href="/dashboard/product-category/add-product-category">
          ...
          <tbody>
            {categories?.length > 0 ? (
              categories?.map((category, index) => (
                ...
                >
                  <td className="px-5 text-sm py-1">
                  ...
                  <td className="px-5 py-1 text-sm text-gray-600">
                    {category.slug}
                  </td>
                  ...
                  <td className="px-5 py-1">
                    <div className="flex justify-center gap-2">
                      <Link
                        href={`/dashboard/product-category/edit-product-category/${category.id}`}
                      >
                        <button
